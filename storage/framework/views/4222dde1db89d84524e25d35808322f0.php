    ...
    <div class='secciones_datos_usuario'> 
        <div class='ficha_user tarjeta'>
            ...
            <?php if(auth()->user()->foto): ?>
                <img id="img_perfil" src="<?php echo e(asset('imagenes/usuarios/' . auth()->user()->foto)); ?>" alt="Foto de <?php echo e(auth()->user()->name); ?>">
            <?php else: ?>
                Sin foto
            <?php endif; ?>
            </div>
...
<?php echo $__env->make('plantillas.paginaPrincipal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\area_de_desarrollo\repositorio_local\mileventos\resources\views/navPrivada.blade.php ENDPATH**/ ?>