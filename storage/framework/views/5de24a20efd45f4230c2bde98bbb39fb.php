...
<?php $__env->startSection('contenido_3'); ?> 
      ...
      <form class='tarjeta' method="POST" action="<?php echo e(route('evento.guardar')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <input type="text" id="titulo" name="titulo"  value="<?php echo e(old('titulo')); ?>" placeholder="Introduce el título" required>
        </div>
        ...
        <select name="ubicacion_id" required>
            ...
            <?php $__currentLoopData = $ubicacionesGlobal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ubicacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($ubicacion->id); ?>"
                    <?php echo e(old('ubicacion_id', $ubicacionSeleccionada) == $ubicacion->id ? 'selected' : ''); ?>>
        ...
        <select name="categoria_id" required>
            ...
            <?php $__currentLoopData = $categoriasGlobal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($categoria->id); ?>"
                    <?php echo e(old('categoria_id', $categoriaSeleccionada) == $categoria->id ? 'selected' : ''); ?>>
        ...
        <div>
            ...
            <input type="date" name="fecha_fin" value="<?php echo e(old('fecha_fin')); ?>" required>
        </div>

        <!-- Descripción -->
        <div>
            <label for="descripcion">Descripción</label>
            <textarea name="descripcion" rows="4" placeholder="Describe el evento"><?php echo e(old('descripcion')); ?></textarea>
        </div>

        <!-- Número de entradas -->
        <div>
            <label for="num_entradas">Número de entradas</label>
            <input type="number" name="num_entradas" min="0" value="<?php echo e(old('num_entradas')); ?>">
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('plantillas.paginaPrincipal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\area_de_desarrollo\repositorio_local\mileventos\resources\views/navFormRegistroEvento.blade.php ENDPATH**/ ?>